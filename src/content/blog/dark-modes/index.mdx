...
import { ThemePreview, ThemePreviewSplits, themePreviewElementConfigs, themePreviewSplitsConfigs }  from '../../../components/themePreview'
...
Another dilemma arises when we have a background and a card, there are several ways to differentiate the background with the foreground. In the light mode, we can enjoy a variety of styles to depict boxes of content.

<ThemePreviewSplits
  client:visible
  {...themePreviewSplitsConfigs.lightCard}
/>
