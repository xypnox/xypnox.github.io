...
It can be used to test out how fonts and color combinations look.
...
Here on the web however, _everything is allowed_. _But not everywhere_. Each page could contain different styles. Basic dark mode is offered by those who can add one, otherwise the style of a page is rather fixed. Only evolving with time.
