...
Fear not, you can visit the [customize](/customize) page for a [Guide](/customize#guide) and the [Showcase](/customize#theme-showcase) for examples showcasing creativity and flexibility. 
