import{b as t,g as e,F as g,i as d,e as l,t as s,q as n}from"./web.BvE3ojRe.js";import{s as v}from"./objects.-XdWwpQU.js";import{s as u,t as c}from"./themeState.DSZfK7qY.js";import"./theme.B-1Y4buH.js";import"./store.C4DiOvhL.js";import"./version.BiGcaLu2.js";var f=s("<div class=swatch style=--color:var(--primary-color)>"),y=s("<div class=swatch style=--color:var(--secondary-color)>"),$=s("<div class=swatch style=--color:var(--surface)>"),b=s("<div class=swatch style=--color:var(--text)>"),x=s("<hr>"),k=s("<h2 id=current-themes>Current Themes"),w=s("<h2>"),m=s("<div class=colors>");const _=v("div")`
  display: grid;
